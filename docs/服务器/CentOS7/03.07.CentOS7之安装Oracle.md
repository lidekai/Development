...
```shell
# oracle的环境变量
export ORACLE_BASE=/opt/oracle/install
...
- 报错：/opt/oracle/product/11.2.0/dbhome_1/ctx/lib/ins_ctx.mk

```
vim /opt/oracle/install/product/11.2.0/db_1/ctx/lib/ins_ctx.mk
```
...
- 报错：/opt/oracle/install/product/11.2.0/db_1/sysman/lib/ins_emagent.mk

```
cp /opt/oracle/install/product/11.2.0/db_1/sysman/lib/ins_emagent.mk /opt/oracle/install/product/11.2.0/db_1/sysman/lib/ins_emagent.mk.bak

vim /opt/oracle/install/product/11.2.0/db_1/sysman/lib/ins_emagent.mk
```
