...
title: 05.05.Mybatis之Classes、Student、Teacher的一对多
---
...
## model层的Classes <a name="java-02" href="#" >:house:</a>
...
## model层的Student <a name="java-03" href="#" >:house:</a>
...
## model层的Teacher <a name="java-04" href="#" >:house:</a>
...
## 测试类TestAll <a name="java-05" href="#" >:house:</a>
...
## 工具类Util <a name="java-06" href="#" >:house:</a>
...
## ClassMapper.xml <a name="java-07" href="#" >:house:</a>
...
## jdbc.properties <a name="java-08" href="#" >:house:</a>
```sql
#mysql
...
```
## log4j.properties <a name="java-09" href="#" >:house:</a>
...
## mybatis-conf.xml <a name="java-10" href="#" >:house:</a>
