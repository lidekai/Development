...
## TestAll <a name="java-02" href="#" >:house:</a>
...
## jdbc.properties <a name="java-05" href="#" >:house:</a>
...
jdbc.password=
```
## log4j.properties <a name="java-06" href="#" >:house:</a>
...
## mybatis-conf.xml <a name="java-07" href="#" >:house:</a>
...
## userMapper.xml <a name="java-08" href="#" >:house:</a>
